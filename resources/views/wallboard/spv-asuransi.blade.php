...
<section id="body_content">
    ...
    <div class="btn-group btn-group-lg" id="nav-timestamp">
        <button type="button" class="btn {{ $sortOption === 'today' ? 'active' : '' }}" id="btn_today_agent_asuransi" onclick="window.location='{{ route('spvAsuransi', ['sort' => 'today']) }}'">Today</button>

        <button type="button" class="btn {{ $sortOption === 'thisWeek' ? 'active' : '' }}" id="btn_tweek_agent_asuransi" onclick="window.location='{{ route('spvAsuransi', ['sort' => 'thisWeek']) }}'">This Week</button>

        <button type="button" class="btn {{ $sortOption === 'thisMonth' ? 'active' : '' }}" id="btn_tmonth_agent_asuransi" onclick="window.location='{{ route('spvAsuransi', ['sort' => 'thisMonth']) }}'">This Month</button>

        <button type="button" class="btn {{ $sortOption === 'default' ? 'active' : '' }}" id="btn_tmonth_agent_asuransi" onclick="window.location='{{ route('spvAsuransi', ['sort' => 'default']) }}'">Show All</button>
    </div>
            ...
            <div class="card shadowed-element">
                ...
                <div class="kartu-konten">
                    ...
                    @else
                        ...
                        <h5 class="card-title">{{ $wallboard->spv_username }}</h5>
